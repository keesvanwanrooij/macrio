...
- [x] Username / password / email changeable with clear nl/en errors
- [x] DOB picker works on Android (Expo Go)
- [x] Diary: tap date → that day; not future
- [x] Reports day: tap → that day; reports week: tap → week containing that day
- [x] Date format setting persists; default DD-MM-YYYY; other formats offered work in UI
- [x] Version string matches Expo config
- [x] Export JSON + diary CSV include agreed datasets; no support email required
- [x] Delete: immediate lockout; purge after 30 days; cannot sign in after delete
- [x] Store account-deletion guideline noted in SETUP or LEGAL briefly
- [x] nl/en via i18n
