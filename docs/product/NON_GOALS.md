...
> What Macrio v1.0 deliberately does NOT do, and when it might.

| Not in v1.0 | Planned | Why deferred |
|---|---|---|
| Workout builder & tracker | v1.1 | Food logging alone is a full build session; workouts deserve their own |
| Body metrics (weight, fat %, muscle kg, progress photos) | v1.1 | Ships naturally with workouts |
| Weighted trust graph & community voting/moderation | v1.2 | Needs real users first; simple likes/versions/reports suffice at launch |
